...
from hummingbot.connector.exchange.eqonex.eqonex_api_order_book_data_source import EqonexAPIOrderBookDataSource


class EqonexOrderBookTracker(OrderBookTracker):
    _eqonexobt_logger: Optional[HummingbotLogger] = None

    @classmethod
    def logger(cls) -> HummingbotLogger:
        if cls._eqonexobt_logger is None:
            cls._eqonexobt_logger = logging.getLogger(__name__)
        return cls._eqonexobt_logger

    def __init__(self,
                 trading_pairs: Optional[List[str]] = None):
        super().__init__(EqonexAPIOrderBookDataSource(trading_pairs), trading_pairs)
